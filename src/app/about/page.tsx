...
export default function About() {
  ...
  return (
    <div className="bg-white">
      <section className="whitespace-editorial container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-20">
          ...
          <div className="md:col-span-6 space-y-20">
            <div
              className="aspect-[4/5] relative overflow-hidden group cursor-pointer grayscale hover:grayscale-0 transition-all duration-1000"
              data-cursor="view"
            >
              <Image
                src="/jp/jp-1.JPG"
                ...
                fill
                className="object-cover transition-all duration-1000 group-hover:opacity-0 group-hover:scale-110"
                sizes="(max-width: 768px) 100vw, 40vw"
                priority
              />
              <Image
                src="/jp/jp-2.JPG"
                alt="Juan Pablo Arakaki - Alt"
                fill
                className="object-cover absolute inset-0 opacity-0 group-hover:opacity-100 transition-all duration-1000 group-hover:scale-110"
                sizes="(max-width: 768px) 100vw, 40vw"
              />

              {/* LinkedIn Overlay */}
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700 flex flex-col items-center justify-end p-10 text-center text-white">
                <div className="mb-4">
                ...
                <p className="text-[10px] font-bold uppercase tracking-[0.3em] mb-2 font-mono">LinkedIn</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-20">
          ...
          <div className="md:col-span-5 md:sticky md:top-32 md:h-fit">
            ...
            <p className="text-md text-gray-500 leading-relaxed font-light mb-6">
              Proceso es una investigación rigurosa sobre la intersección del sitio, la estructura y el impacto social.
            </p>
      ...
      <section className="whitespace-editorial container mx-auto px-6 max-w-7xl text-center pt-32">
