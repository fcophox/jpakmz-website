         ...
         <section className="whitespace-editorial container mx-auto px-6 max-w-7xl py-24">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 sm:gap-24">
               <div className="md:col-span-4 sticky top-32 h-fit">
                  ...
                  <div className="space-y-8 font-mono mt-16 pl-16">
                     <div>
                    ...
                    <div className="max-w-2xl space-y-16">
                       {project.concept && (
                          <div>
                             ...
                             <p className="text-gray-600 leading-relaxed text-lg font-light whitespace-pre-line">{renderText(project.concept)}</p>
                          </div>
                       )}
                       {project.context && (
                          <div>
                             ...
                             <p className="text-gray-600 leading-relaxed text-lg font-light whitespace-pre-line">{renderText(project.context)}</p>
                          </div>
                       )}
                    </div>
                  )}
            ...
            return (
               ...
               >
                  ...
                  <div className="relative z-20 text-center">
                     ...
                     <h2 className="text-4xl sm:text-7xl font-medium text-white transition-all duration-700 editorial-title tracking-tight">
                        {nextProject.title}
                     </h2>
                  </div>
               </Link>
